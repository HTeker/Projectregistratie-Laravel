        	...
        	{{ Form::open(array('class'=>'uk-form', 'id'=>'search-form')) }}
				<div class="uk-form-row">
					<div class="uk-form-icon">
					    ...
					    {{ Form::text('cohort',null,array('placeholder'=>'Zoek een cohort','class'=>'uk-width-1-1', 'id'=>'search', 'autofocus'=>'autofocus')) }}
					</div>
				</div>
			{{ Form::close() }}
		<br>
					...
					$.ajax({
						...
						success: function(data){
							...
							if(data.length == 0){
								...
								$.each(data, function() {
									msg += "<tr><td>" + this.id + "</td><td>" + this.naam + "</td><td>" + this.crebos.naam + "</td><td><a onclick='deleteRecord( \"" + resource + "\"," + this.id + ");'><i class='uk-icon-trash-o uk-icon c-blue place-right'></i> </a></td></tr>";
								});
